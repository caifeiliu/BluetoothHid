package com.virtual.joystick.android;
...
public class JoystickView extends View implements Runnable {
    ...
    public interface OnMoveListener {
         ...
         * @param obj JoystickView
         * @param obj event
         * @param angle current angle
         * @param strength current strength
         */
        void onMove(JoystickView obj, MotionEvent event, int angle, int strength);
    }
    /**
    ...
    private static final boolean DEFAULT_AUTO_RECENTER_BUTTON_CORDINATE = true;
    ...
    private boolean mAutoReCenterButtonCordinate;
    /**
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mAutoReCenterButtonCordinate = styledAttributes.getBoolean(R.styleable.JoystickView_JV_autoReCenterButtonCordinate, DEFAULT_AUTO_RECENTER_BUTTON_CORDINATE);
    ...
    private void initPosition() {
        ...
        mPoint.x = mFixedCenterX;
        mPoint.y = mFixedCenterY;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mAutoReCenterButton) {
                ...
                if (mAutoReCenterButtonCordinate && mCallback != null)
                    mCallback.onMove(this, event, getAngle(), getStrength());
            }
    ...
    public boolean isAutoReCenterButtonCordinate(){
        return mAutoReCenterButtonCordinate;
    }
    /**
    ...
    public void setAutoReCenterButtonCordinate(boolean b) {
        mAutoReCenterButtonCordinate = b;
    }
    /**
    ...
    public void run() {
        while (!Thread.interrupted()) {
            post(new Runnable() {
                public void run() {
                    if (mCallback != null)
                        mCallback.onMove(obj,null,getAngle(), getStrength());
                    //Log.v("u-joystick","run");
                }
            });
